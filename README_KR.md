...
- 약 90개의 가상 머신 감지 기술 [[목록](https://github.com/NotRequiem/VMAware/blob/main/docs/documentation.md#flag-table)]
- 그리고 가장 선구적인 감지 기술
- VMAware, VirtualBox, QEMU, Hyper-V등을 포함하는 70가지 이상의 VM 브랜드 감지 [[목록](https://github.com/NotRequiem/VMAware/blob/main/docs/documentation.md#brand-table)]
- VM 보안 강화 무력화
...
- C++11 이상부터 호환
- Rust, JavaScript, Ruby 등 다른 언어로의 포트 생태계 포함
- 순수 헤더 파일 구현
- 외부 종속성이 없음
...
## 설치 방법 📥
[최신 릴리즈](https://github.com/NotRequiem/VMAware/releases/latest)에서 vmaware.hpp 파일을 다운로드하고, 프로젝트에 추가하세요. 미리 컴파일된 바이너리 파일들도 준비되어 있습니다.  
...
| 언어 | 저장소 | 세부사항 | 작성자 |
|:---------|:---------------:|:--------:|:------:|
| <img src="assets/language_icons/8172-ruby-programming-language.webp" width="20"> Ruby | [링크](https://github.com/NotRequiem/VMAware/tree/main/gem) | VMAware 저장소에 내장된 공식 Ruby 포트이지만, Windows는 지원되지 않습니다. | [Adam Ruman](https://github.com/addam128) |
...
| <img src="assets/language_icons/rust-logo-512x512.png" width="20"> Rust | [링크](https://github.com/MarcelDev/vmaware-rs) | 뛰어난 API, 충분히 테스트됨, 활발히 유지보수 중 | [Marcel](https://github.com/MarcelDev) |
...
>
> 이 라이브러리는 다른 프로젝트들 에서도 활용되고 있습니다. 대표적으로 고급 멀웨어 분석 프로젝트인 [AutoVirt](https://github.com/Scrut1ny/AutoVirt)에서 가상 머신 모니터링  환경과 은밀성을 개선하는데 도움을 주었습니다.
...
## 이슈, 토론, PR 및 문의 📬
어떤 형태로든 제안, 아이디어 공유, 그리고 기여를 환영합니다! [이슈](https://github.com/NotRequiem/VMAware/issues) 또는 [토론](https://github.com/NotRequiem/VMAware/discussions) 에서 자유롭게 소통하실 수 있으며, 최대한 빠르게 답변 드리고자 노력하고 있습니다. 개인적인 소통은 Discord를 통해 `kr.nl` 혹은 `shenzken` 에게 직접 연락해 주세요.


이메일 연락처: `vmaware.support@gmail.com`
